...
class GradientDescentPlot(Scene):
    ...
    def construct(self):
        ...
        learning_rate = 0.25  # Set to 0.001

        # Number of iterations
        num_iterations = 10  # Increased to 4000

        # Animation update frequency
        animation_interval = 1  # Animate every 500 iterations
        ...
        for idx, it in enumerate(animate_iterations):
            ...
            self.play(
                ...
                Create(new_poly),
                run_time=0.7  # Total gradient descent animation time ~5.6 seconds (8 * 0.7)
            )
